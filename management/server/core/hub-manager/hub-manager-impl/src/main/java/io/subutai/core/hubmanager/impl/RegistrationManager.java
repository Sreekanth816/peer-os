...
class RegistrationManager
{
    ...
    {
        log.info( "Registering peer public key with Subutai Bazaar..." );
        ...
        {
            throw new HubManagerException( "Error registering peer public key with Subutai Bazaar: " + restResult.getError() );
        }
    ...
    {
        log.info( "Registering peer with Subutai Bazaar..." );
    ...
    void unregister() throws HubManagerException
    {
        ...
        {
            log.info( "Peer or its pubic key not found on Subutai Bazaar. Unregistered anyway." );
        }
